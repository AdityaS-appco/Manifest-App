...
class MostListenedTracks extends StatefulWidget {
  const MostListenedTracks({Key? key}) : super(key: key);

  @override
  State<MostListenedTracks> createState() => _MostListenedTracksState();
}

class _MostListenedTracksState extends State<MostListenedTracks> {
  int? _sliding = 0;
  @override
            ...
            Padding(
              ...
              child: Column(
                ...
                children: [
                  ListTile(
                    leading: Image.asset(
                      AppImages.mostListenedTracksStar,
                      fit: BoxFit.cover,
                      height: 80,
                      width: 80,
                    ),
                  ...
                  Container(
                    ...
                    child: Column(
                      ...
                      children: [
                        ...
                        ListView.builder(
                            shrinkWrap: true,
                            itemCount: min(DummyData.dummyData.length, 1),
