...
mixin ExploreLoadingStateMixin {
  // Loading states for explore-related operations
  final RxBool isExploreDataLoading = false.obs;
  final RxBool isFetchingCategories = false.obs;
  ...
  void startFetchingCategories() => isFetchingCategories.value = true;
  void stopFetchingCategories() => isFetchingCategories.value = false;
  ...
  void startExploreDataLoading() => isExploreDataLoading.value = true;
  void stopExploreDataLoading() => isExploreDataLoading.value = false;
