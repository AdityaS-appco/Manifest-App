...
import 'package:manifest/core/shared/widgets/bottomsheets/bug_report_submitted_bottomsheet.dart';
...
class ReportBugScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    final SuggestionOption selectedOption = SuggestionOption(
      label: "Report a bug",
    ...
    return CommonAuthFormScaffold(
      title: "Report a bug",
      subtitle: "Help us squash bugs! Report any issues you encounter here.",
      bottomsheet: Column(
...
class ReportBugController extends GetxController {
  ...
  Future<void> onSave() async {
    ...
    try {
      ...
      /// * success bottomsheet
      await AppBottomSheet.show(const BugReportSubmittedBottomsheet());
